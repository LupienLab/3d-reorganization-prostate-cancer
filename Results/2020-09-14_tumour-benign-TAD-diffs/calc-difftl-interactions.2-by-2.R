...
BENIGN_SAMPLES <- metadata[Source == "Primary" & Type == "Benign", SampleID][1:2] # only take two of each in this smaller example
TUMOUR_SAMPLES <- metadata[Source == "Primary" & Type == "Malignant", SampleID][1:2]
