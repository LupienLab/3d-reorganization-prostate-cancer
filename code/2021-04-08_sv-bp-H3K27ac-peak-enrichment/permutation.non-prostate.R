...
# Meta
# ==============================================================================
# permutation.non-prostate
# --------------------------------------
# Description: Permutation testing for SV breakpoints in non-prostate cancer samples
# Author: James Hawley
...
PLOT_DIR <- file.path(RES_DIR, "Plots", "non-prostate")
...
# Analysis
# ==============================================================================
loginfo("Performing permutations")
